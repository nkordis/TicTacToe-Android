...
import murachandroidworkplace.tictactoe_android.*;
...
public abstract class AIPlayer {
    protected int ROWS = MainActivity.ROWS; // number of rows
    protected int COLS = MainActivity.COLS; // number of columns
